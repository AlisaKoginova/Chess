...
public class Player {
    public boolean white; // переменна€, определ€юща€ цвет игрока: 1 - белый, 0 - черный
    ...
    public List<Piece> getPieces() { // функци€ дл€ возврата фигур коллекции 
        return pieces;
    }
    
    // функци€ инициализации фигур
    public void initPieces(){ 
        if(this.white == true) // если игрок белого цвета
        {
            for(int i=0; i<8; i++) // добавл€ем р€д пешек
                pieces.add(new Pawn(true,i,2)); 
            
            // добавл€ем по очереди остальные фигуры
